...
class MenuBuilder:
    ...
    def show_dialog(self, title, text):
        ...
        # Adding hyperlinks
        add_hyperlink("hyper1", "https://bit.ly/ApInsight-Setup", "4.0", "4.end")
        add_hyperlink("hyper2", "https://bit.ly/ApInsight", "7.0", "7.end")
